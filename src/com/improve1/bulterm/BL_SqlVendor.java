...
public class BL_SqlVendor {
	/*
	private String getTermsSql(String columnName, String symbolsToSearch,
			int firstRowNo, int lastRowNo, boolean isNotLimited) {
		...
		if (symbolsToSearch != null) { // columnToSearch != null &&
			sqlQuery = " select"
					...
					//+ "  , em1.name_a tnEnglish, em2.name_a tnBulgarian, em3.name_a tnRussian, em4.name_a nGerman,  em5.name_a tnFrench"
					+ " from entries e"
					+ " inner join entries_multilanguage em on em.entry_id = e.id"
					+ "   and em.language_id = ?";
			if (!isNotLimited) {
			...
			sqlQuery += " left  join terms_multilanguage tm on    tm.term_id  = e.id"
					+ "   and tm.language_id = 2"
	...
	private String getTermAdaptedSql() {
	...
	public String getResultsCountSql() {
	...
	sqlCount += " left  join terms_multilanguage tm on    tm.term_id  = e.id"
			+ "   and tm.language_id = 2"
			...
			+ " where em_bulgarian.name_a is not null " 
			+" ) a";
	}//getResultsCountSql
	private String getTermsAllSql(int rowToStartWith, int countPerPage, int selectedLanguageId, String symbolsToSearch) {
		String sqlQuery = null;
        ...
        if (!symbolsToSearch.equals("")) {
			...
			case 1:    sqlQuery += "em1.name_a";      break;
			case 2:    sqlQuery += "em2.name_a";      break;
			case 3:    sqlQuery += "em3.name_a";      break;
			case 4:    sqlQuery += "em4.name_a";      break;
			case 5:    sqlQuery += "em5.name_a";      break;
	        //default: xxx;     	break;
			}//switch		
